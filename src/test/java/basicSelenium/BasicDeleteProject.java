...
public class BasicDeleteProject {
    ChromeDriver driver;
    ...
    public void loginTodoLy() throws InterruptedException {
        ...
        //2) Set Email
        driver.findElement(By.xpath("//input[@name='ctl00$MainContent$LoginControl1$TextBoxEmail']")).sendKeys("kevinpomier.kp@gmail.com");
        //3) Set Password
        driver.findElement(By.xpath("//input[@name='ctl00$MainContent$LoginControl1$TextBoxPassword']")).sendKeys("kevingay");
        ...
        Assert.assertEquals("El projecto no fue eliminado",expectedResult,actualResult);
